defmodule Ballot.Impl do
  ...
  def defense_score(ballot), do: ballot.defense_score
  ...
  def point_differential(ballot, :prosecution) do
    ballot.prosecution_score - ballot.defense_score
  end

  def point_differential(ballot, :defense) do
    ballot.defense_score - ballot.prosecution_score
  end
  ...
  def prosecution_score(ballot), do: ballot.prosecution_score
  ...
  def tie?(ballot), do: ballot.prosecution_score == ballot.defense_score

  def total_score(ballot, :prosecution), do: ballot.prosecution_score
  def total_score(ballot, :defense), do: ballot.defense_score

  def total_score(%{defense: team} = ballot, team) do
    ballot.defense_score
  end

  def total_score(%{prosecution: team} = ballot, team) do
    ballot.prosecution_score
  end

  def total_score(_, _), do: 0

  def win?(ballot, :prosecution) do
    ballot.prosecution_score > ballot.defense_score
  end

  def win?(ballot, :defense) do
    ballot.defense_score > ballot.prosecution_score
  end
end
