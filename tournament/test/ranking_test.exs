defmodule RankingTest do
  ...
  test "regular rankings: ballots won, point differential, distance traveled" do
    ...
    round1_rankings = Ranking.Team.rankings(r1_ballots)
    ...
    assert Ranking.Team.ranking(r1_ballots, venture) == 1
    assert Ranking.Team.ranking(r1_ballots, redlands) == 2
    assert Ranking.Team.ranking(r1_ballots, trinity) == 3
    assert Ranking.Team.ranking(r1_ballots, shasta) == 4
    assert Ranking.Team.ranking(r1_ballots, carmel) == 5
    assert Ranking.Team.ranking(r1_ballots, king) == 6
    assert Ranking.Team.ranking(r1_ballots, university) == 7
    assert Ranking.Team.ranking(r1_ballots, tam) == 8
    ...
    round2_rankings = Ranking.Team.rankings(r1_r2_ballots)
    ...
    round3_rankings = Ranking.Team.rankings(r1_r2_r3_ballots)
    ...
    # round4_rankings = Ranking.Team.final_rankings(r1_r2_r3_r4_ballots)

    final_rankings = Ranking.Team.final_rankings(r1_r2_r3_r4_ballots)
    ...
    assert Ranking.Team.final_ranking(r1_r2_r3_r4_ballots, redlands) == 1
    assert Ranking.Team.final_ranking(r1_r2_r3_r4_ballots, venture) == 2
    assert Ranking.Team.final_ranking(r1_r2_r3_r4_ballots, tam) == 3
    assert Ranking.Team.final_ranking(r1_r2_r3_r4_ballots, shasta) == 4
    assert Ranking.Team.final_ranking(r1_r2_r3_r4_ballots, king) == 5
    assert Ranking.Team.final_ranking(r1_r2_r3_r4_ballots, carmel) == 6
    assert Ranking.Team.final_ranking(r1_r2_r3_r4_ballots, trinity) == 7
    assert Ranking.Team.final_ranking(r1_r2_r3_r4_ballots, university) == 8
